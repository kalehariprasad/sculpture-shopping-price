...
#batch prediction 
BATCH_INPUT_FILE=os.path.join(ROOT_DIR,PREDICTION_FOLDER,BATCH_INPUT_FOLDER,INPUT_CSV)
BATCH_OUTPUT_FILE=os.path.join(ROOT_DIR,PREDICTION_FOLDER,BATCH_OUTPUT_FOLDER,OUTPUT_CSV)
BATCH_FE_DATA_FILE=os.path.join(ROOT_DIR,PREDICTION_FOLDER,BATCH_FE_FOLDER,BATCH_FE_DATA)
